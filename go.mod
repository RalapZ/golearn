module github.com/Ralap.Z/learn
...
require (
	...
	github.com/nnmatveev/idea-plugin-protobuf v0.5.7 // indirect
...
replace github.com/lucas-clemente/quic-go => github.com/lucas-clemente/quic-go v0.10.1
